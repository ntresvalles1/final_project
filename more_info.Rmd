...
```{r, echo = FALSE}
#Trasnform into leaflet--------------
nyc_biketrails_leaflet <- st_transform(bike_routes, 4326)
bike_accidents_leaflet_sf <- 
  st_transform(nyc_accidents, 4326)

bins <- c(0, 20, 40, 60, Inf)
pal <- colorBin(palette = "OrRd", domain = bike_accidents_leaflet$count, bins = bins)
